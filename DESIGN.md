...
- Graphite ink and linen surfaces create the base; signal teal marks only
...
- Type is one system sans with a measured scale: display for screen identity,
  title for sections, body for content, label for metadata and controls.
