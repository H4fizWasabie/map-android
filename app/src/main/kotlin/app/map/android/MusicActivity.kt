...
class MusicActivity : ComponentActivity() {
    ...
    private fun renderPlayer() {
        ...
        sleepLabel = TextView(this).apply { text = ""; MapUi.metadata(this); gravity = Gravity.CENTER; setPadding(0, dp(6), 0, 0) }
    ...
    private fun decodeArtwork(bytes: ByteArray, requestedSize: Int): android.graphics.Bitmap? {
        ...
        val maxDimension = requestedSize.coerceAtMost(MAX_ARTWORK_PIXELS)
        var sample = 1
